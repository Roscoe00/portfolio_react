      ...
      <div className="about" id="about">
         ...
         <div className="about__grid">
            ...
            <p className="about__paragraph-two">
               I decided to specifically persue coding and software development after finishing a degree in mathematics, and really enjoying the use of programs like MatLAB and R Studio. I joined the Technology Consultancy Programme ran by _nology in order to gain the skills I needed to become a Software Engineer and am now looking to put these skills to test with my first junior role.
            </p>
